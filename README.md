...
B.Tech student in **Artificial Intelligence & Data Science**, focused on building production-ready AI applications — not just notebooks.

I work across the full AI stack: from training deep learning models and designing ML pipelines to shipping full-stack web apps with real users. My goal is to build systems that bridge the gap between research and real-world impact.

Currently exploring: **RAG systems · Computer Vision pipelines · MLOps · Defense-sector AI applications**
...
| [📊 Student Performance Predictor](https://github.com/akash-dev-ai-brat/student-performance-predictor) | Predictive Analytics | XGBoost, SHAP, Streamlit | [▶ Demo](#) |
...
**AI / ML**
`Python` `TensorFlow` `PyTorch` `scikit-learn` `XGBoost` `OpenCV` `MediaPipe` `YOLOv8` `HuggingFace`

**Data Science**
`Pandas` `NumPy` `Matplotlib` `Seaborn` `Plotly` `Jupyter` `Prophet` `SHAP`
...
<div align="center">
  <i>Open to internships and research collaborations in AI/ML and Data Science.</i><br>
